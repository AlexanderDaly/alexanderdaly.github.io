// Authentic Three.js Glitch Effect (Based on Original Woody Theme)
class AuthenticGlitchEffect {
    constructor() {
    ...
    setupPostEffect() {
        ...
        this.scene.add(this.postMesh);
        this.postUniforms = postMaterial.uniforms;
    }
    ...
    setupEventListeners() {
        window.addEventListener('resize', () => {
            this.resizeCanvas();
            if (this.bgUniforms) {
                this.bgUniforms.resolution.value.set(window.innerWidth, window.innerHeight);
            }
            this.postUniforms.resolution.value.set(window.innerWidth, window.innerHeight);
        });
    }
    ...
    animate() {
        ...
        this.renderer.render(this.sceneBack, this.cameraBack, this.renderTarget);
        
        // Render post effect to screen
